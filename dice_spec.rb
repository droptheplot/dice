  ...
  describe '#probability' do
    context 'for given amount of dices and magic number' do
      ...
      it 'returns correct probability' do
        ...
        expect(@calculator.probability(3, 15)).to be_within(0.1).of(5.0 / 108)
        expect(@calculator.probability(100, 100)).to be_within(0.1).of(1.531 * 10 ** - 78)
        expect(@calculator.probability(300, 300)).to be_within(0.1).of(3.586 * 10 ** - 234)
      end
    end
  end
end
